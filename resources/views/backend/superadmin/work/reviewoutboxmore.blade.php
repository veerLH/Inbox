        ...
        <div class="col-md-8">
            <div class="card">
                    <div class="card-header">
                            <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="far fa-edit" style="float:left; font-size:2em;color:#0d47a1"></i></a>&nbsp;&nbsp;&nbsp;<a href="{{url('/super/outbox/'.$outboxs->id.'/delete')}}"><i class="far fa-trash-alt" style="float: right;font-size:2em;color:#CC0000"></i></a>
                    </div>
                ...
                <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLongTitle">ထွက်စာနှင့်သက်ဆိုင်သောအချက်အလက်များပြင်ဆင်ရန်</h5>
                        ...
                        <div class="modal-body">
                                <div class="card border-success col-md-12 mx-auto" id="department">
                                        <div class="card-header col-md-12 d-flex justify-content-center" id="headertxt">Write OutBox</div>
                                        <div class="card-body">
