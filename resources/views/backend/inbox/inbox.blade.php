    ...
    <div class="row d-flex justify-content-center" id="department">
            <div class="col-md-4" >
                    <form method="POST" action="{{url('admin/inboxsearch')}}">
                        @csrf
                            <label class="sr-only" for="inlineFormInputGroup">အမည်</label>
    ...
    <div class="row mx-auto">
        <div class="col-md-12 mx-auto">
            <div class="card border-danger">
                    <div class="card-header col-md-12 d-flex justify-content-center myanmar" id="headertxt">ဝင်စာများ</div>
                    <div class="card-body">
                            <div class="table-responsive">
                            <table class="table table-hover">
                                    <thead class="table-primary myanmar">
                                      <tr>
                                    ...
                                    <tbody>
                                      ...
                                      <th scope="row">{{$inbox->inboxid}}</th>
                                        ...
                                        <td class="text-danger font-weight-bold"><a href="{{url('admin/inbox/'.$inbox->id.'/more')}}">အပြည့်အစုံ</a></td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                                  </table>
