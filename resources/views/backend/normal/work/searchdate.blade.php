...
<div class="row mx-auto">
    <div class="col-md-12 mx-auto">
        <div class="card border-warning">
                <div class="card-header col-md-12 d-flex justify-content-center" id="headertxt">ရက်စွဲအလိုက်ရှာဖွေထားသောဝင်စာများ</div>
                <div class="card-body">
                        <table class="table table-hover">
                                ...
                                <tbody>
                                  ...
                                  <th scope="row">{{$inbox->inboxid}}</th>
                                    ...
                                    <td class="text-danger font-weight-bold"><a href="{{url('normal/inbox/'.$inbox->id.'/more')}}">More --</a></td>
                                  </tr>
        ...
        <div class="pagination justify-content-end">
                {{$inboxs->appends(Request::only(['datesearch'=>'datesearch']))->render()}}
        </div>
    </div>
</div>
</div>
